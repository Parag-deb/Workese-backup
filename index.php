...
<header class="bg-black text-white">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="space-x-4">
            <a class="hover:text-teal-400" href="/log in/index.html">Login</a>
            <a class="bg-[rgb(34,197,94)] text-white px-4 py-2 rounded hover:bg-green-600" href="/create account/index.html">Register</a>
        </div>
...
<section class="bg-cover bg-center text-center py-20" style="background-image: url('../images/Screenshot\ 2025-01-12\ 143606.png')">
...
<section class="bg-teal-500 text-white py-12">
    <div class="container mx-auto px-4 flex justify-center space-x-8">
        <div class="bg-white text-black p-8 rounded shadow-md text-center">
            ...
            <button class="bg-[rgb(34,197,94)] text-white px-4 py-2 mt-4 rounded hover:bg-green-600" onclick="window.location.href='/create account/index.html'">
                Apply Now
            </button>
...
<section class="py-12">
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center">
            ...
            <a class="text-teal-500 hover:underline" href="/jobs/index.html">View all</a>
        </div>
    ...
    <div class="container mx-auto px-4 flex flex-col lg:flex-row items-center">
        ...
        <div class="mt-8 lg:mt-0 lg:ml-8">
            ...
            <div class="mt-8 flex space-x-4">
                <button class="bg-[rgb(34,197,94)] text-white px-6 py-2 rounded hover:bg-green-600" onclick="window.location.href='/jobs/index.html'">
                    Search Job
                </button>
                
                <button class="bg-gray-200 text-gray-700 px-6 py-2 rounded hover:bg-gray-300" onclick="window.location.href='/about us/index.html'">
                    Learn more
                </button>
            </div>
        </div>
